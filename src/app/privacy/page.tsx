...
const sections: Section[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "current limits: 30 downloads per minute, 5 playlist downloads per minute (max 200 tracks per playlist), 15 searches per minute, and 10 metadata lookups per minute. higher limits may be available in the future — check the roadmap.",
    ],
  },
  {
